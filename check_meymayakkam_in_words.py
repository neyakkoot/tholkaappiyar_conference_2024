...
rulesets = [meymayakkam1, meymayakkam2, meymayakkam3, meymayakkam4, meymayakkam5, meymayakkam6, meymayakkam7, meymayakkam8, meymayakkam9, meymayakkam10, meymayakkam11, meymayakkam12, meymayakkam13, meymayakkam14, meymayakkam15, meymayakkam16, meymayakkam17, meymayakkam18]
...
with open("all-tamil-nouns.txt", "r") as myfile, open("சரியான_சொற்கள்.txt", 'w') as correctfile, open('தவறான_சொற்கள்.txt', 'w') as wrongfile, open('ஆய்விற்குட்படா_சொற்கள்.txt', 'w') as ommitedfile :
    for line in myfile.readlines():
        ...
        try:
            ...
            if any(result) and False not in result:
...
labels = ['ஓரெழுத்து, ஈரெழுத்துச் சொற்கள்',  'சரியான_சொற்கள்', 'தவறான_சொற்கள்', 'ஆய்விற்குட்படாச்சொற்கள்']
...
fig = px.pie(values=வரைபடமதிப்பீடு, names=labels, color=labels, color_discrete_map={'ஆய்விற்குட்படாச்சொற்கள்':'grey',
                                 'சரியான_சொற்கள்':'green',
                                 'தவறான_சொற்கள்':'red',
                                 'ஓரெழுத்து, ஈரெழுத்துச் சொற்கள்':'darkblue'}   )
fig.show()
